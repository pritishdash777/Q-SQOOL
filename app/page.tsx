...
function Learning({ openLesson, tryModule }: { openLesson: (id: string) => void; tryModule: (id: string) => void }) {
  ...
  const recommended = recommendedModules(accountProgress, role, assessed ? assessmentScore : undefined).map(module => module.id);
